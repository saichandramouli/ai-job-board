export const mockJobs = [
  {
    ...
    logo: "⚡",
    logoBg: "bg-purple-100 dark:bg-purple-950/50 text-purple-600 dark:text-purple-400",
    ...
    benefits: [
      ...
      "Flexible working hours and hybrid work-from-home options.",
  ...
  },
  {
    ...
    company: "Cognitive OS",
    logo: "🧠",
    logoBg: "bg-blue-100 dark:bg-blue-950/50 text-blue-600 dark:text-blue-400",
    ...
    benefits: [
      ...
      "Home office stipend ($2,000 setup budget).",
      "Learning & development allowance ($1,500/year).",
  ...
  },
  {
    ...
    company: "Synthetica",
    logo: "🔮",
    logoBg: "bg-emerald-100 dark:bg-emerald-950/50 text-emerald-600 dark:text-emerald-400",
    ...
    benefits: [
      ...
      "State-of-the-art office space in Manhattan with catered daily lunch.",
  ...
  {
    id: "4",
    title: "AI Agents Solutions Architect",
    company: "Agentify Corp",
    logo: "🤖",
    logoBg: "bg-amber-100 dark:bg-amber-950/50 text-amber-600 dark:text-amber-400",
    ...
    benefits: [
      "Flexible schedule.",
      "High hourly billing rates with path to permanent role.",
      "Access to cutting-edge model APIs and testbeds."
    ]
  }
];
